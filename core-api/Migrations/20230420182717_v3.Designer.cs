            ...
            modelBuilder.Entity("WhereIsOurCar.PositionHistory.Entity.PositionHistoryPhoto", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_position_history_photo");

                    b.HasIndex("FullId")
                        .HasDatabaseName("ix_position_history_photo_full_id");

                    b.HasIndex("PositionHistoryId")
                        .HasDatabaseName("ix_position_history_photo_position_history_id");

                    b.HasIndex("ThumbId")
                        .HasDatabaseName("ix_position_history_photo_thumb_id");

                    b.ToTable("position_history_photo", (string)null);
                });
            ...
            modelBuilder.Entity("WhereIsOurCar.PositionHistory.Entity.PositionHistoryPhoto", b =>
                {
                    b.HasOne("WhereIsOurCar.File.Entity.S3File", "Full")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_position_history_photo_s3_file_full_id");
                    ...
                    b.HasOne("WhereIsOurCar.PositionHistory.Entity.PositionHistory", "PositionHistory")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_position_history_photo_position_history_position_history_id");
                    ...
                    b.HasOne("WhereIsOurCar.File.Entity.S3File", "Thumb")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_position_history_photo_s3_file_thumb_id");
