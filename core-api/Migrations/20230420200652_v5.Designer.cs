            ...
            modelBuilder.Entity("WhereIsOurCar.Photo.Entity.Photo", b =>
                {
                    ...
                    b.HasIndex("FullId")
                        .HasDatabaseName("ix_photo_full_id");

                    b.HasIndex("ThumbId")
                        .HasDatabaseName("ix_photo_thumb_id");
            ...
            modelBuilder.Entity("WhereIsOurCar.Photo.Entity.Photo", b =>
                {
                    b.HasOne("WhereIsOurCar.File.Entity.S3File", "Full")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_photo_s3_file_full_id");
                    ...
                    b.HasOne("WhereIsOurCar.File.Entity.S3File", "Thumb")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_photo_s3_file_thumb_id");
            ...
            modelBuilder.Entity("WhereIsOurCar.PositionHistory.Entity.PositionHistoryPhoto", b =>
                {
                    b.HasOne("WhereIsOurCar.Photo.Entity.Photo", "Photo")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_position_history_x_photo_photo_photo_id");
